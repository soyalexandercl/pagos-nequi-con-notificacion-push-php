...
// Configurar la URL del endpoint de Nequi para pagos no registrados
curl_setopt($ch, CURLOPT_URL, "https://api.nequi.com/payments/v2/-services-paymentservice-unregisteredpayment");
